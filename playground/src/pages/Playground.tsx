...
export default function Playground() {
  ...
  return (
    <div className="flex h-full bg-linear-to-br from-slate-50 via-blue-50 to-purple-50">
      {/* Left Sidebar */}
      <div className="w-72 bg-white border-r border-slate-200 flex flex-col overflow-hidden shadow-lg">
        <div className="px-3 py-2 border-b border-slate-200 bg-linear-to-r from-blue-50 to-indigo-50">
        ...
        <div className="flex-1 overflow-y-auto">
          {error && (
            <div className="p-1.5 m-1.5 bg-red-50 border border-red-200 rounded-lg">
              ...
              {manifest.components.map(comp => (
                <li key={comp.name}>
                  <button
                    ...
                    className={`
                      w-full text-left p-1.5 rounded-lg border-l-4 transition-all duration-200
                      ${selectedComponent === comp.name 
                        ? 'bg-linear-to-r from-blue-50 to-indigo-50 border-blue-500 shadow-sm' 
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="px-3 py-1.5 border-b border-slate-200 bg-white shadow-sm">
        ...
        <div className="flex-1 p-4 overflow-y-auto bg-linear-to-br from-slate-50 to-blue-50/30">
          {isLoading ? (
              ...
              <div className="text-center space-y-4">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-8 h-8 bg-linear-to-br from-blue-400 to-indigo-500 rounded-full animate-pulse"></div>
                  </div>
                </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                <div className="bg-linear-to-r from-slate-50 to-blue-50 px-3 py-1.5 border-b border-slate-200">
                  <div className="flex items-center justify-between">
